...
<root>
  ...
  ├── Editor
  │   ├── Undefined.ConfigsContainer.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.ConfigsContainer.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.ConfigsContainer.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.ConfigsContainer.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.ConfigsContainer`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Configs Container Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.ConfigsContainer.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.ConfigsContainer.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.ConfigsContainer.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.ConfigsContainer.Tests.asmdef`
